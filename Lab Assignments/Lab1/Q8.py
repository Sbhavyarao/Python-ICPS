...
y_pred=MR.predict(X)
print("R^2(VARIANCE): %.2f" % r2_score(Y,y_pred))
print("RMSE(MEAN_SQUARED_ERROR): %.2f" % mean_squared_error(Y,y_pred))
...
print("R^2(VARIANCE): %.2f" % r2_score(Y_train,y_pred))
print("RMSE(MEAN_SQUARED_ERROR): %.2f" % mean_squared_error(Y_train,y_pred))
